...
public class AdminControllerWithOutSecurityTest {
    ...
    @Test
    public void AdminController_UpdateUser_ReturnUpdatedUserDto() throws Exception {
        long userId = 1L;
        ...
        response.andExpect(status().isOk())
                .andExpect(jsonPath("$.username", CoreMatchers.is(updatedUserDto.getUsername())))
                .andExpect(jsonPath("$.email", CoreMatchers.is(updatedUserDto.getEmail()))
                );
    }
